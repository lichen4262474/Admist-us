/**
 * This class represents the Player class in the Amidst Us game. It will
...
public abstract class Player implements Comparable<Player> {
	 ...
	 * properly populates the players array. The logic in this constructor ensures
	 * that players is always full, although frozen players will still be in it.
	 ...
	 *                 being more suspicious. Negative values will be set to a
	 *                 minimum of 0.
	 */
	...
	/**
	 * This method is an abstract method called emergencyMeeting. This method will
	 * be overridden by any child class and will be used to have an emergency
	 * meeting.
	 */
	// YOUR CODE HERE
	abstract void emergencyMeeting();
	/**
	 * This method is the compareTo method from the Comparable interface. It will
	 * compare two Player objects based on their susLevel
	 * 
	...
	public int compareTo(Player p) {
		// YOUR CODE HERE
		return -(susLevel - p.susLevel); // delete this once you have implemented this method
	}
	...
	/**
	 * This method overrides the toString method to specify what will be returned if
	 * a specific instance of a Player object is printed out.
	 * 
	...
	public String toString() {
		...
		return "My name is " + this.name + ", and I have a susLevel of " + this.susLevel + ". I am currently "
		+ frozenString + ".";
	}
